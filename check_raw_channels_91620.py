...
filedir = '/Volumes/bs005r/SJB00015/sjb15_2020-01-31_09-32-37_p10c1'  #SJB15 D1 Saline
# filedir = '/Volumes/bs005r/SJB00015/sjb15_2020-01-31_14-14-29_p10c1/' #SJB15 D2 Saline
os.chdir(filedir)
...
probenumber = 0 # starts from zero
...
figurename = str('SJB15' + '_' +  list_of_files[0][-23:-4] + '__' + list_of_files[-1][-23:-4] + str('_') + str(probenumber+1) + '.png')
arrayname = str('SJB15' + '_' +  list_of_files[0][-23:-4] + '__' + list_of_files[-1][-23:-4] +  str('_') + str(probenumber+1) + '.npy')
